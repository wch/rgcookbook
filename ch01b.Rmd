...
To make a scatter plot (Figure \@ref(fig:FIG-QUICK-SCATTER-GGPLOT)), add `geom_point()` to your base ggplot:
...
To make a line graph (Figure \@ref(fig:FIG-QUICK-LINE-GGPLOT)), add `geom_line()` to your base ggplot:
...
To make a bar graph (Figure \@ref(fig:FIG-QUICK-BAR-GGPLOT)), add `geom_bar()` to your base ggplot. To plot a bar graph of *values*, use `geom_col()`. Notice the difference in the output when the *x* variable is continuous and when it is discrete:
...
To make a histogram (Figure \@ref(fig:FIG-QUICK-HIST-GGPLOT)), add `geom_histogram()` to your base ggplot:
...
To make a box plot (Figure \@ref(fig:FIG-QUICK-BOXPLOT-GGPLOT)), add `geom_boxplot()` to your base ggplot:
...
> **Note**
>
> You can see how the quantiles are calculated by looking at `?geom_boxplot`.
...
To make a function curve (Figure \@ref(fig:FIG-QUICK-FUNCTION-GGPLOT)), add `stat_function(geom = "line")` to your bass plot and pass it a function that takes a numeric vector as input and returns a numeric vector:
