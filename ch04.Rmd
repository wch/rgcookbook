...
mapped to x and y ([figure\_title](#FIG-LINE-GRAPH-BASIC-LINE)):
...
([figure\_title](#FIG-LINE-GRAPH-BASIC-LINE-FACTOR)). When the *x*
...
([figure\_title](#FIG-LINE-GRAPH-BASIC-LINE-YLIM)):
...
Add geom\$\$\_\$\$point() ([figure\_title](#FIG-LINE-GRAPH-POINT)):
...
[figure\_title](#FIG-LINE-GRAPH-BASIC-LINE-YLIM) with
[figure\_title](#FIG-LINE-GRAPH-POINT)).
...
([figure\_title](#FIG-LINE-GRAPH-POINTS-INTERVAL)):
...
[figure\_title](#FIG-LINE-GRAPH-MULTI-LINE-COLOR-TYPE):
...
([figure\_title](#FIG-LINE-GRAPH-MULTI-LINE-FACTOR)):
...
[figure\_title](#FIG-LINE-GRAPH-MULTI-LINE-SAWTOOTH):
...
([figure\_title](#FIG-LINE-GRAPH-MULTI-LINE-SHAPE-FILL)):
...
([figure\_title](#FIG-LINE-GRAPH-MULTI-LINE-DODGE)). When doing so, you
...
[figure\_title](#FIG-BAR-GRAPH-BASIC-LINE-CUSTOMIZED)) by passing them
...
[figure\_title](#FIG-LINE-GRAPH-MULTI-LINE-PALETTE), by using
...
([figure\_title](#FIG-LINE-GRAPH-MULTI-LINE-CONSTANT-AES)). You may also
...
[figure\_title](#FIG-LINE-GRAPH-POINT-PROPERTIES)):
...
[figure\_title](#FIG-LINE-GRAPH-POINT-WHITEFILL):
...
[figure\_title](#FIG-LINE-GRAPH-MULTI-LINE-POINT-PALETTE), specify shape
...
[figure\_title](#FIG-LINE-GRAPH-AREA):
...
[figure\_title](#FIG-LINE-GRAPH-AREA-OUTLINE). We'll also add an
...
[figure\_title](#FIG-LINE-GRAPH-AREA-TOPLINE):
...
([figure\_title](#FIG-LINE-GRAPH-STACKED-AREA)):
...
([figure\_title](#FIG-LINE-GRAPH-STACKED-AREA-CUSTOMIZED)) reverses the
...
of aes() ([figure\_title](#FIG-LINE-GRAPH-STACKED-AREA-REVSTACK)):
...
rid of it ([figure\_title](#FIG-LINE-GRAPH-STACKED-AREA-NOSIDES)), first
...
([figure\_title](#FIG-LINE-GRAPH-PROPORTIONAL-STACKED-AREA)):
...
([figure\_title](#FIG-LINE-GRAPH-REGION)):
...
([figure\_title](#FIG-LINE-GRAPH-REGION-LINES)):
