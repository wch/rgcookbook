...
```{r FIG-APPEARANCE-TITLE, fig.show="hold", fig.cap="Left: scatter plot with a title added; right: with a `\\n` for a newline"}
...
```{r FIG-APPEARANCE-TEXT-APPEARANCE-GEOM, fig.show="hold", fig.cap='Left: `annotate("text")`; right: `geom_text()`'}
...
```{r FIG-APPEARANCE-THEME, fig.show="hold", fig.cap="Left: scatter plot with `theme_grey()` (the default); right: with `theme_bw()`"}
library(gcookbook) # For the data set
