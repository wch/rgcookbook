...
[figure\_title](#FIG-APPEARANCE-TITLE):
...
([figure\_title](#FIG-APPEARANCE-TITLE-INSIDE)). The first method is to
...
the title text ([figure\_title](#FIG-APPEARANCE-TEXT-APPEARANCE), left):
...
example ([figure\_title](#FIG-APPEARANCE-TEXT-APPEARANCE), right):
...
[figure\_title](#FIG-APPEARANCE-TEXT-APPEARANCE-PROPERTIES).
...
([figure\_title](#FIG-APPEARANCE-THEME)):
...
([figure\_title](#FIG-APPEARANCE-THEME-MODIFY)):
...
([figure\_title](#FIG-APPEARANCE-THEME-SAVE)):
...
them both, as shown in [figure\_title](#FIG-APPEARANCE-HIDE-GRIDLINES)
(left):
...
[figure\_title](#FIG-APPEARANCE-HIDE-GRIDLINES), with
