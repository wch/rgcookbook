...
You will first need to install the package using the following commands (the latest [installation instructions](https://github.com/thomasp85/patchwork) can be found on github):
