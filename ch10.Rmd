...
([figure\_title](#FIG-LEGEND-REMOVE)):
...
([figure\_title](#FIG-LEGEND-POSITION), left):
...
([figure\_title](#FIG-LEGEND-POSITION), right). The coordinate space
...
[figure\_title](#FIG-LEGEND-POSITION-JUSTIFICATION):
...
([figure\_title](#FIG-LEGEND-POSITION-BACKGROUND), left):
...
([figure\_title](#FIG-LEGEND-POSITION-BACKGROUND), right):
...
([figure\_title](#FIG-LEGEND-ORDER)):
...
([figure\_title](#FIG-LEGEND-ORDER2), left):
...
([figure\_title](#FIG-LEGEND-ORDER2), right):
...
of the legend, as in [figure\_title](#FIG-LEGEND-TITLE-REVERSE) (for
...
([figure\_title](#FIG-LEGEND-TITLE)):
...
of the titles ([figure\_title](#FIG-LEGEND-TITLE-MULTI)):
...
([figure\_title](#FIG-LEGEND-TITLE-MULTI-SAME), left):
...
To change the title ([figure\_title](#FIG-LEGEND-TITLE-MULTI-SAME),
...
([figure\_title](#FIG-LEGEND-TITLE-MULTI-SAME), middle):
...
([figure\_title](#FIG-LEGEND-TITLE-APPEARANCE)):
...
from a legend, as in [figure\_title](#FIG-LEGEND-TITLE-REMOVE) (for
other aesthetics, replace fill with the name of the aesthetic, such as
colour or size):
...
Set the labels in the scale ([figure\_title](#FIG-LEGEND-LABEL), left):
...
[figure\_title](#FIG-LEGEND-LABEL):
...
([figure\_title](#FIG-LEGEND-LABEL-ORDER)):
...
[figure\_title](#FIG-LEGEND-LABEL-MULTI-SAME):
...
([figure\_title](#FIG-LEGEND-LABEL-APPEARANCE)):
...
([figure\_title](#FIG-LEGEND-LABEL-MULTILINE), left):
...
[figure\_title](#FIG-LEGEND-LABEL-MULTILINE), with the default settings
...
theme() ([figure\_title](#FIG-LEGEND-LABEL-MULTILINE), right). To do
