...
(ref:cap-FIG-LEGEND-POSITION-BACKGROUND) Legend with opaque background and outline (left); With no background or outlines (right)

```{r cap-FIG-LEGEND-POSITION-BACKGROUND, ref.label=c("FIG-LEGEND-POSITION-BACKGROUND-1", "FIG-LEGEND-POSITION-BACKGROUND-2"), echo=FALSE, fig.cap="(ref:cap-FIG-FACET-LABEL-TEXT-LABELLER)", fig.width=3}
```
