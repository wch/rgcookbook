...
library(gcookbook)  # Load the gcookbook package to access the pg_mean data set
...
```{r}
library(gcookbook) # Load the gcookbook package to access the uspopchange data set
library(dplyr)
...
library(gcookbook) # Load the gcookbook package to access the tophitters2001 data set
