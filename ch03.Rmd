...
[figure\_title](#FIG_BAR_GRAPH_GROUPED_BAR_OUTLINE) we'll use the
...
[figure\_title](#FIG_BAR_GRAPH_COLOR_NEG2). We'll also add a thin
...
([figure\_title](#FIG_BAR_LABEL_STACKED_FINAL)), we'll change the
...
[figure\_title](#FIG_BAR_GRAPH_DOTPLOT_ORDERED_SWAP). We'll also
