...
# Save a base plot called `faithful_p` (for faithful plot)
faithful_p <- 
  ggplot(faithful, aes(x = waiting))
...
# Create a base plot using the heightweight data set called `hw_p` (for heightweight plot)
hw_p <- 
...
# Save a base plot object called `faithful_p` (for faithful plot)
faithful_p <- 
  faithful %>% 
