...
[figure\_title](#FIG_DISTRIBUTION_HIST_QUANTIZE), we'll use a bin
...
([figure\_title](#FIG_DISTRIBUTION_DENSITY_WIDTH)). We'll also add
...
([figure\_title](#FIG_DISTRIBUTION_DOTPLOT_BASIC)), we'll use a
...
[figure\_title](#FIG_DISTRIBUTION_DOTPLOT_HISTODOT), you'll notice
...
([figure\_title](#FIG_DISTRIBUTION_DENSITY2D_BANDWIDTH)), we'll use
