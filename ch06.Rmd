...
(ref:cap-FIG-DISTRIBUTION-DENSITY-BASIC) Left: a kernel density estimate curve with `geom_density()`; right: with `geom_line()`
...
(ref:cap-FIG-DISTRIBUTION-DENSITY-WIDTH) Left: density curve with wider x limits and a semitransparent fill; right: in two parts, with `geom_density()` and `geom_line()`
