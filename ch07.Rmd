...
([figure\_title](#FIG_ANNOTATE_LINES)). For this example, we'll use
...
it in a data frame, hw\$\$\_\$\$means. Then we'll draw a horizontal
...
We'll work with the full cabbage\$\$\_\$\$exp data set this time:
...
The default dodge width for geom\$\$\_\$\$bar() is 0.9, and you'll
