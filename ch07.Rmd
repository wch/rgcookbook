...
Use annotate() and a text geom ([figure\_title](#FIG-ANNOTATE-TEXT)):
...
[figure\_title](#FIG-ANNOTATE-TEXT-PROPERTIES):
...
In [figure\_title](#FIG-ANNOTATE-TEXT-GEOM-OVERPLOT), each text label is
...
[figure\_title](#FIG-ANNOTATE-TEXT-EDGE). You will also need to adjust
...
([figure\_title](#FIG-ANNOTATE-TEXT-MATH)):
...
other, as in [figure\_title](#FIG-ANNOTATE-TEXT-MATH-MIX), put a
...
([figure\_title](#FIG-ANNOTATE-LINES)). For this example, we'll use
...
([figure\_title](#FIG-ANNOTATE-LINES-MULTI)):
...
([figure\_title](#FIG-ANNOTATE-LINES-FACTOR)):
...
([figure\_title](#FIG-ANNOTATE-SEGMENT)):
...
([figure\_title](#FIG-ANNOTATE-SEGMENT-ARROWS)):
...
Use annotate("rect") ([figure\_title](#FIG-ANNOTATE-RECT)):
...
([figure\_title](#FIG-ANNOTATE-HIGHLIGHT)):
...
graphs, as shown in [figure\_title](#FIG-ANNOTATE-ERRORBAR-BASIC)
...
bars ([figure\_title](#FIG-ANNOTATE-ERRORBAR-GROUP-BAR)):
...
[figure\_title](#FIG-ANNOTATE-ERRORBAR-GROUP-LINE-DODGE):
...
([figure\_title](#FIG-ANNOTATE-FACET)):
...
facet, as shown in [figure\_title](#FIG-ANNOTATE-FACET-MATH). For
