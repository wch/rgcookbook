...
([figure\_title](#FIG-COLORS-SETTING)):
...
one of the columns in the data ([figure\_title](#FIG-COLORS-MAPPING)):
...
([figure\_title](#FIG-COLORS-MAPPING-FACTOR)):
...
ColorBrewer palette ([figure\_title](#FIG-COLORS-PALETTE-DISCRETE)):
...
[figure\_title](#FIG-COLORS-PALETTE-LIGHTNESS) (right), set the value of
...
[figure\_title](#FIG-COLORS-PALETTE-BREWER):
...
([figure\_title](#FIG-COLORS-PALETTE-BREWER-NAME)):
...
range, as shown in [figure\_title](#FIG-COLORS-PALETTE-GREY).
...
([figure\_title](#FIG-COLORS-PALETTE-DISCRETE-MANUAL)). The colors can
...
([figure\_title](#FIG-COLORS-PALETTE-DISCRETE-COLORBLIND)):
...
[figure\_title](#FIG-COLORS-PALETTE-DISCRETE-COLORBLIND-CHART).
...
([figure\_title](#FIG-COLORS-PALETTE-CONTINUOUS)). The colors can be
...
[figure\_title](#FIG-COLORS-AREA-VALUE):
...
([figure\_title](#FIG-COLORS-AREA-VALUE-INTERPOLATED)). This time
