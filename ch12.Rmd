...
The viridis color scales come loaded with the newest version of ggplot2 (3.0.0). There are also other color palettes that are friendly to users with color blindness, such as those in cetcolor package (link below.) 

### See Also

To see more on the different viridis palettes, see `?scales::viridis_pal`.

The cetcolor scales: <http://thecoatlessprofessor.com/software-releases/cetcolor-v0.2.0-released-cet-perceptually-uniform-color-maps-with-support-for-colour-blind-users-and-short-names>. 

More information on colorblindness: <http://jfly.iam.u-tokyo.ac.jp/color>.
