...
```{r FIG-FACET-FACET-WRAP, fig.cap="A scatter plot with `facet_wrap()` on class"}
# Facet on class
...
```{r FIG-FACET-LABEL-TEXT-LABELLER, ref.label=c("FIG-FACET-LABEL-TEXT-LABELLER-1", "FIG-FACET-LABEL-TEXT-LABELLER-2"), echo=FALSE, fig.cap="With `label_both()` (left); With `label_parsed()` for mathematical expressions (right)", fig.width=2.5}
```
