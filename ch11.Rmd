...
```{r FIG-FACET-LABEL-TEXT-LABELLER, ref.label=c("FIG-FACET-LABEL-TEXT-LABELLER-1", "FIG-FACET-LABEL-TEXT-LABELLER-2"), echo=FALSE, fig.cap="Left: with `label_both()`; right: with `label_parsed()` for mathematical expressions", fig.width=2.5}
```
