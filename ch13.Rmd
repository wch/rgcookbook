...
```{r FIG-MISCGRAPH-HEATMAP, echo=FALSE, fig.cap="A heat map-the grey squares represent `NA`s in the data", fig.width=13, fig.height=2}
...
```{r FIG-MISCGRAPH-VECTORFIELD-FACET, fig.cap="Vector field of wind speeds, faceted on `z`", fig.width=9, fig.height=6, warning=FALSE}
