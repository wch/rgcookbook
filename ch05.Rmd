...
There are a number of columns in the `heightweight` data set, but we'll only use two in this example (Figure \@ref(fig:FIG-SCATTER-BASIC)):
...
The grouping variable you choose must be categorical -- in other words, a factor or character vector. If the grouping variable is a numeric vector, you should convert it to a factor variable first.
