...
[figure\_title](#FIG_SCATTER_OVERPLOT_ALPHA). Here, we'll make them
...
model (as you'll see in [figure\_title](#FIG_SCATTER_FIT_MODEL)):
...
([figure\_title](#FIG_SCATTER_RUG)), we'll use the faithful data
