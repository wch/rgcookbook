...
([figure\_title](#FIG-SCATTER-BASIC)):
...
(\#21), as seen in [figure\_title](#FIG-SCATTER-BASIC-SHAPE-SIZE)
(left):
...
([figure\_title](#FIG-SCATTER-BASIC-SHAPE-SIZE), right):
...
aesthetics colour or shape ([figure\_title](#FIG-SCATTER-SHAPE-COLOR)):
...
([figure\_title](#FIG-SCATTER-SHAPE-COLOR-BOTH), left):
...
([figure\_title](#FIG-SCATTER-SHAPE-COLOR-BOTH), right):
...
([figure\_title](#FIG-SCATTER-SHAPES)), specify the shape in
geom\$\$\_\$\$point():
...
[figure\_title](#FIG-SCATTER-SHAPES-CHART) shows the shapes that are
...
pounds or more ([figure\_title](#FIG-SCATTER-SHAPES-FILL)):
...
[figure\_title](#FIG-SCATTER-CONTINUOUS-COLOR-SIZE):
...
[figure\_title](#FIG-SCATTER-CONTINUOUS-COLOR-SIZE) have about 36 times
...
[figure\_title](#FIG-SCATTER-CONTINUOUS-FILL), because the outline sets
...
[figure\_title](#FIG-SCATTER-CONTINUOUS-SIZE-CATEGORICAL-COLOR),
...
[figure\_title](#FIG-SCATTER-BASIC-SHAPE-SIZE) in
...
The scatter plot in [figure\_title](#FIG-SCATTER-OVERPLOT) contains
...
[figure\_title](#FIG-SCATTER-OVERPLOT-ALPHA). Here, we'll make them
...
[figure\_title](#FIG-SCATTER-OVERPLOT-BIN2D). With the binned
...
[figure\_title](#FIG-SCATTER-OVERPLOT-BIN2D), right), we can manually
set the range from 0 to the maximum, 6000, using limits
([figure\_title](#FIG-SCATTER-OVERPLOT-BIN2D), left):
...
([figure\_title](#FIG-SCATTER-OVERPLOT-BINHEX)). It works just like
...
[figure\_title](#FIG-SCATTER-OVERPLOT-BINHEX).
...
axes, as shown in [figure\_title](#FIG-SCATTER-OVERPLOT-JITTER). In
...
[figure\_title](#FIG-SCATTER-OVERPLOT-BOXPLOT). This will convey a
...
[figure\_title](#FIG-SCATTER-OVERPLOT-BOXPLOT). To tell it how to group
...
([figure\_title](#FIG-SCATTER-FIT-LM)):
...
by setting colour ([figure\_title](#FIG-SCATTER-FIT-LM), bottom right):
...
[figure\_title](#FIG-SCATTER-FIT-LOESS). Both of these will have the
same result:
...
([figure\_title](#FIG-SCATTER-FIT-LOGISTIC)) by telling
...
([figure\_title](#FIG-SCATTER-FIT-GROUP)):
...
right-hand image of [figure\_title](#FIG-SCATTER-FIT-GROUP), you must
...
model (as you'll see in [figure\_title](#FIG-SCATTER-FIT-MODEL)):
...
([figure\_title](#FIG-SCATTER-FIT-MODEL)):
...
([figure\_title](#FIG-SCATTER-FIT-MODEL-LOGISTIC)):
...
([figure\_title](#FIG-SCATTER-FIT-MODEL-MULTI)):
...
As you can see in [figure\_title](#FIG-SCATTER-FIT-MODEL-MULTI-RANGE),
...
([figure\_title](#FIG-SCATTER-FIT-MODEL-TEXT)):
...
([figure\_title](#FIG-SCATTER-FIT-MODEL-TEXT-AUTO)):
...
([figure\_title](#FIG-SCATTER-RUG)), we'll use the faithful data
...
([figure\_title](#FIG-SCATTER-RUG-JITTER)). This helps the viewer see
...
geom\$\$\_\$\$text(). For this example, we'll use the countries data
...
the coordinates and label ([figure\_title](#FIG-SCATTER-LABEL), left).
...
([figure\_title](#FIG-SCATTER-LABEL), right), use geom\$\$\_\$\$text()
...
the point ([figure\_title](#FIG-SCATTER-LABEL-VJUST), left), and setting
...
([figure\_title](#FIG-SCATTER-LABEL-VJUST), right):
...
([figure\_title](#FIG-SCATTER-LABEL-HJUST), left), and to right-justify,
...
([figure\_title](#FIG-SCATTER-LABEL-HJUST), right):
...
Now we can make the plot ([figure\_title](#FIG-SCATTER-LABEL-SELECT)).
...
of the dots ([figure\_title](#FIG-SCATTER-BALLOON), left), which is not
...
scale\$\$\_\$\$size\$\$\_\$\$area()
([figure\_title](#FIG-SCATTER-BALLOON), right):
...
[figure\_title](#FIG-SCATTER-BALLOON-CAT):
...
66.8 NA 52.2
To make the scatter plot matrix ([figure\_title](#FIG-SCATTER-SPLOM)),
...
shown in [figure\_title](#FIG-SCATTER-SPLOM-PANELS). (LOWESS is slightly
...
([figure\_title](#FIG-SCATTER-SPLOM-PANELS2)). This is done by setting
pch=".":
