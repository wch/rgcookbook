...
```{r FIG-SCATTER-OVERPLOT-BIN2D, echo=FALSE, fig.show="hold", fig.cap="Binning data with `stat_bin2d()` (left); With more bins, manually specified colors, and legend breaks (right)
"}
diamonds_sp +
  stat_bin2d() +
  theme(
...
```{r FIG-SCATTER-OVERPLOT-BINHEX, fig.show="hold", fig.cap="Binning data with `stat_binhex()` (left); Cells outside of the range shown in grey (right)"}
