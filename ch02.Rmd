...
```{r FIG-QUICK-BAR-GGPLOT, fig.show="hold", fig.cap="Left: bar graph of values using `geom_col()` with a continuous x variable; right: with x variable converted to a factor (notice that there is no entry for 6)"}
library(ggplot2)
