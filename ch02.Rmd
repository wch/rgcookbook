...
```{r FIG-QUICK-LINE-BASE, echo=FALSE, fig.show="hold", fig.cap="Left: line graph with base graphics; right: with points and another line", fig.width=3.5, fig.height=3.5}
plot(pressure$temperature, pressure$pressure, type="l")
...
```{r FIG-QUICK-LINE-GGPLOT, echo=FALSE, fig.show="hold", fig.cap="Left: line graph with qplot() from ggplot2; right: with points added", fig.width=3.5, fig.height=3.5}
...
See Chapter \@ref(CHAPTER_LINE_GRAPH) for more in-depth information about creating line graphs.
...
```{r FIG-QUICK-BAR-BASE, echo=FALSE, fig.show="hold", fig.cap="Left: bar graph of values with base graphics; right: bar graph of counts", fig.width=3.5, fig.height=3.5}
...
```{r FIG-QUICK-BAR-GGPLOT, echo=FALSE, fig.show="hold", fig.cap="Left: bar graph of values with qplot() with continuous x variable; right: with x variable converted to a factor (notice that there is no entry for 6)", fig.width=3.5, fig.height=3.5}
library(ggplot2)
...
```{r FIG-QUICK-BAR-GGPLOT-COUNT, echo=FALSE, fig.show="hold", fig.cap="Left: bar graph of counts with qplot() with continuous x variable; right: with x variable converted to a factor", fig.width=3.5, fig.height=3.5}
# Bar graph of values. This uses the BOD data frame, with the
#"Time" column for x values and the "demand" column for y values.
...
See Chapter \@ref(CHAPTER_BAR_GRAPH) for more in-depth information about creating bar graphs.
...
```{r FIG-QUICK-HIST-BASE, fig.show="hold", fig.cap="Left: histogram with base graphics; right: with more bins. Notice that because the bins are narrower, there are fewer items in each bin.", fig.width=3.5, fig.height=3.5}
hist(mtcars$mpg)
...
```{r FIG-QUICK-HIST-GGPLOT, fig.show="hold", fig.cap="Left: ggplot2 histogram with default bin width; right: with wider bins", fig.width=3.5, fig.height=3.5}
library(ggplot2)
...
```{r FIG-QUICK-BOXPLOT-BASE, fig.show="hold", fig.cap="Left: box plot with base graphics; right: with multiple grouping variables", fig.width=3.5, fig.height=3.5}
plot(ToothGrowth$supp, ToothGrowth$len)
...
```{r FIG-QUICK-BOXPLOT-GGPLOT, fig.show="hold", fig.cap="Left: box plot with `ggplot()`; right: with multiple grouping variables", fig.width=3.5, fig.height=3.5}
...
```{r FIG-QUICK-FUNCTION-BASE, fig.show="hold", fig.cap="Left: function curve with base graphics; right: with user-defined function", fig.width=3.5, fig.height=3.5}
...
```{r FIG-QUICK-FUNCTION-GGPLOT, fig.show="hold", fig.cap="A function curve with ggplot2", fig.width=3.5, fig.height=3.5}
library(ggplot2)
