...
Although IRSQUOve used the ggplot2 package for most of the graphics in
this book, it is not the only way to make graphs. For very quick
exploration of data, itRSQUOs sometimes useful to use the plotting
functions in base R. These are installed by default with R and do not
require any additional packages to be installed. TheyRSQUOre quick to
type, are straightforward to use in simple cases, and run very quickly.

If you want to do anything beyond very simple graphs, though, itRSQUOs
...
Sometimes LDQUObar graphRDQUO refers to a graph where the bars represent
...
ItRSQUOs also possible to make box plots for multiple variables, by
